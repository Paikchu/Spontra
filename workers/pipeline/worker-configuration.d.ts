/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/pipeline/wrangler.jsonc --include-runtime=false workers/pipeline/worker-configuration.d.ts` (hash: cf6cfb0f589f8b25c1bfcbdb960761f9)
interface __BaseEnv_Env {
	...
	SEC_ANALYSIS_MODEL: "deepseek-flash";
	SEC_REASONING_MODEL: "deepseek-flash";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SEC_USER_AGENT" | "SEC_ANALYSIS_MODEL" | "SEC_REASONING_MODEL" | "DEEPSEEK_API_KEY">> {}
}
